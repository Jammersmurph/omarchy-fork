...
Jammarchy is Jameson's customized distribution built on Omarchy Quattro.
...
Jammarchy and Omarchy are released under the [MIT License](https://opensource.org/licenses/MIT).
